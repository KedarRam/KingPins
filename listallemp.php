...
<tr><td><mark>EMP ID</mark></td><td><mark>USERNAME</mark></td><td><mark>FIRSTNAME</mark></td><td><mark>LASTNAME</mark></td><td><mark>E-MAIL</mark></td><td><mark>PRIMARY PHONE</mark></td><td><mark>STATUS</mark></td><td><mark>TITLE</mark></td><td><mark>JOIN DATE</mark></td><td><mark>LAST PROFILE UPDATE DATE</mark></td></tr>
<?php
$sqlQuery = "SELECT * FROM employee";
        ...
        while ($i < $count) {
            ...
            ?>
<tr><td><?php echo $id?></td><td><?php echo $username?></td><td><?php echo $firstname?></td><td><?php echo $lastname?></td><td><?php echo $email?></td><td><?php echo $phone?></td><td><?php echo $active?></td><td><?php echo $manager ?></td><td><?php echo $joindate?></td><td><?php echo $updatedate?></td></tr>
        <?php $i++; } ?>
